...
description: "Thea answers Discord questions from your docs, tracks invite campaigns, and runs AutoMod, tickets, and a help center from one dashboard."
---

Thea is an AI Discord bot that turns the documentation you already have into an always-on support layer. Every answer cites the passage it used. When confidence is below the threshold you set, Thea hands off to your staff instead of guessing. The same install tracks invite campaigns and runs layered AutoMod, private-channel tickets, and a public help center.
...
<CardGroup cols={2}>
  ...
  <Card title="Community" icon="users" href="/community/welcome">
    Welcome, onboarding forms, invite campaigns, announcements, saved replies, and server logs.
  </Card>
...
- **Invite campaign tracking** — gross joins, honest attribution coverage, qualified and active members, and mature 7- and 30-day retention.
